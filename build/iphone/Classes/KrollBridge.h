...
@interface TiGoogleGeocodingObject : KrollCoverageObject {
#else
@interface TiGoogleGeocodingObject : KrollObject {
#endif
@private
...
extern NSString * TiGoogleGeocoding$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiGoogleGeocodingObject *_tigooglegeocoding;
	BOOL shutdown;
