...
// in simulator we redefine to format for TiGoogleGeocoding Developer console
...
{\
	NSString * exceptionName = [@"org.tigooglegeocoding." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tigooglegeocoding";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiGoogleGeocodingNativeItemNone = -1, 
	UITiGoogleGeocodingNativeItemSpinner = -2,
	UITiGoogleGeocodingNativeItemProgressBar = -3,
	
	UITiGoogleGeocodingNativeItemSlider = -4,
	UITiGoogleGeocodingNativeItemSwitch = -5,
	UITiGoogleGeocodingNativeItemMultiButton = -6,
	UITiGoogleGeocodingNativeItemSegmented = -7,
	
	UITiGoogleGeocodingNativeItemTextView = -8,
	UITiGoogleGeocodingNativeItemTextField = -9,
	UITiGoogleGeocodingNativeItemSearchBar = -10,
	
	UITiGoogleGeocodingNativeItemPicker = -11,
	UITiGoogleGeocodingNativeItemDatePicker = -12,
	
	UITiGoogleGeocodingNativeItemInfoLight = -13,
	UITiGoogleGeocodingNativeItemInfoDark = -14,
	
	UITiGoogleGeocodingNativeItemDisclosure = -15,
	
	UITiGoogleGeocodingNativeItemContactAdd = -16
};
