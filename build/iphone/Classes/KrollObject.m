 ...
 * Copyright (c) 2009-2011 by TiGoogleGeocoding, Inc. All Rights Reserved.
...
//@interface TiGoogleGeocodingObject : NSObject
//@end

@interface TiGoogleGeocodingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiGoogleGeocodingObject class]])
		{
			for (NSString *key in [[(TiGoogleGeocodingObject*)o modules] allKeys])
			{
